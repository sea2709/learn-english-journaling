              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    minLength={8}
                    className="w-full rounded-lg border border-ink-200 bg-ink-50/50 px-3 py-2 pr-10 text-sm text-ink-900 focus:border-sage-400 focus:outline-none focus:ring-2 focus:ring-sage-200"
                  />
                  <button
                    type="button"
