...
const BUY_ME_A_COFFEE_URL = "https://buymeacoffee.com/englishjournal";
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M6 8h10a1 1 0 0 1 1 1v5.5A3.5 3.5 0 0 1 13.5 18h-3A3.5 3.5 0 0 1 7 14.5V9a1 1 0 0 1 1-1Zm11 1.5h.75A2.75 2.75 0 0 1 20.5 12.25v0A2.75 2.75 0 0 1 17.75 15H17M8 21h8M9 3.5c.5.75.5 1.5 0 2.25M12 3.5c.5.75.5 1.5 0 2.25M15 3.5c.5.75.5 1.5 0 2.25"
      />
    </svg>
  );
}
...
export function TopActionsMenu({
  ...
  const accountMenuItems = (
    <>
      ...
      <a
        role="menuitem"
        className="top-actions-dropdown-item no-underline"
